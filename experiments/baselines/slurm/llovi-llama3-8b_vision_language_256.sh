...
python scripts/run_llovi_captioning.py \
    ...
    --output_path data/captions/llovi_qwen2.5-vl-7b_1fps_256f.json \
...
python scripts/run_llovi_inference.py \
    ...
    --captions_path data/captions/llovi_qwen2.5-vl-7b_1fps_256f.json \
...
python scripts/run_llovi_captioning.py \
    --data_path data/test_expert.csv \
    --output_path data/captions/llovi_qwen2.5-vl-3b_1fps_2f.json \
...
python scripts/run_llovi_inference.py \
    ...
    --video_dir /lustre/fswork/projects/rech/kcn/ucm72yx/data/SF20K/videos/ \
    --model_name llovi-llama3-8b \
    --captions_path data/captions/llovi_qwen2.5-vl-3b_1fps_2f.json \
    --output_dir scripts/results
