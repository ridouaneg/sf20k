...
python run_inference.py     --output_path results/qwen2.5-vl-7b_vision_language_16.json     --data_path ../../data/test_expert.csv     --subtitles_path ../../data/test_subtitles.csv     --video_dir /lustre/fswork/projects/rech/kcn/ucm72yx/data/SF20K/     --weights_dir /lustre/fsmisc/dataset/HuggingFace_Models/Qwen/     --model_name qwen2.5-vl-7b     --modality vision_language     --fps 1.0     --max_frames 16
