...
def load_video(video_path: str, start: float, end: float, num_frames: int = 1, target_size: tuple = (640, 360)) -> list[Image.Image]:
    """Loads a video from a file and returns a list of PIL images."""
