...
for config in [
    "qwen3-vl-2b_1024_32f",
    "qwen3-vl-2b_2048_32f",
    "qwen3-vl-2b_4096_32f",
    "qwen3-vl-2b_8192_32f",
    "qwen3-vl-2b_16384_32f",
    # 4b? 8b? more frames? less samples?
]:
    slurm_script = TEMPLATE.format(config=config)
    with open(f"./slurm/{config}.sh", "w") as f:
        f.write(slurm_script)
    print(f"Created {config} slurm scripts")