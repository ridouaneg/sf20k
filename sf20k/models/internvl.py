...
class InternVLModel:
    ...
    def generate(
        ...
        **kwargs,
        ...
        #pixel_values, num_patches_list = load_video(video_path, bound=None, input_size=448, max_num=1, num_segments=32)
        pixel_values, num_patches_list = load_video(video_path, bound=None, input_size=448, max_num=1, num_segments=self.num_frames)
